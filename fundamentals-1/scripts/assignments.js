...
/************** Basic operators **************/
console.log("half of the population in the half country are: " + population / 2);
population += 1;
console.log("population incremented by 1: " + population);
let finlandPopulation = 6000000;
let aCountry = 33000000;
finlandPopulation > population ? console.log("finland population is higher") : console.log("my country population is higher");
aCountry > population ? console.log("A country population is higher") : console.log("my country population is higher");

let description = 'my country is in Europe, and its 11 million people speak portuguese';
...
if (population > 33000000) console.log("my country population is above average");
...
population > 33000000 ? console.log("my country population is higher") : console.log("my country population is lower");
